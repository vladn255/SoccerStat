...
const handleYearClick = () => {
  ...
  return (
    <div className="input-group mb-3">
      <input type="text" className="form-control" placeholder={`${listType} name`} name aria-label={`${listType} name`} aria-describedby="basic-addon2" onChange={handleSearchInput}/>
      <div className="input-group-append">
        <button type="button" className="btn btn-outline-secondary" onClick={handleSearchClick}>Search</button>
      </div>
